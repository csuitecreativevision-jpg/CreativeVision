    ...
    <section id="services" className="w-screen h-screen flex-shrink-0 flex items-center justify-center relative overflow-hidden bg-[#050511] px-6">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
          ...
          <motion.p variants={itemVariants} className="max-w-md text-gray-400 text-base leading-relaxed hidden md:block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <motion.div variants={itemVariants} className="h-full">
            <SpotlightCard className="h-full rounded-3xl bg-white/5 p-8 md:p-10 border-white/10 relative overflow-hidden group">
          ...
          {/* Join Team Card */}
          <motion.div variants={itemVariants} className="h-full">
            <SpotlightCard className="h-full rounded-3xl bg-custom-purple/10 p-8 md:p-10 border-white/10 relative overflow-hidden group">
              <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-20 transition-opacity duration-500">
