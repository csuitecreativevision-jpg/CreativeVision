...
export default function Services({ onGetStarted }: ServicesProps) {
  ...
  return (
    <section id="services" className="w-screen h-[100svh] flex-shrink-0 flex items-center justify-center relative overflow-hidden bg-[#050511] px-[clamp(1rem,3vw,2rem)]">
      {/* Background Ambience */}
      <div className="absolute top-0 right-0 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-custom-purple/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-custom-blue/10 rounded-full blur-[120px] pointer-events-none" />

      <motion.div
        className="max-w-7xl mx-auto relative z-10 w-full h-full flex flex-col justify-center py-[clamp(0.5rem,3vh,3rem)]"
      ...
      >
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-[clamp(0.5rem,3vh,3rem)] gap-2 md:gap-4 flex-shrink-0">
          <motion.div variants={itemVariants}>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 mb-1 md:mb-4">
            ...
            <h2 className="text-[clamp(1.75rem,5vw,6rem)] font-bold text-white leading-tight">
              Cinematic{' '}
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-[clamp(0.5rem,2vw,1.5rem)] flex-1 min-h-0 w-full md:flex-none md:h-auto overflow-y-auto md:overflow-visible no-scrollbar">
          ...
          <motion.div variants={itemVariants} className="flex-1 min-h-0 w-full md:flex-none md:aspect-[16/10]">
            <SpotlightCard className="h-full rounded-2xl md:rounded-3xl bg-white/5 p-[clamp(1rem,2.5vw,2.5rem)] border-white/10 relative overflow-hidden group flex flex-col justify-center">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                  <div className="w-[clamp(2rem,4vw,3rem)] h-[clamp(2rem,4vw,3rem)] rounded-xl bg-custom-bright/20 flex items-center justify-center mb-[clamp(0.5rem,2vh,1.5rem)] border border-white/10 shrink-0">
                    <Zap className="w-[clamp(1rem,2vw,1.5rem)] h-[clamp(1rem,2vw,1.5rem)] text-custom-bright" />
                  </div>
                  <h3 className="text-[clamp(1.25rem,2.5vw,2.5rem)] font-bold text-white mb-1 md:mb-2 shrink-0">Hire CreativeVision</h3>
                  <p className="text-gray-400 text-[clamp(0.7rem,0.9vw,1rem)] mb-[clamp(0.75rem,2vh,2rem)] max-w-sm line-clamp-2 md:line-clamp-none">
                    Transform your raw footage into high-converting assets with professional turnaround.
                  </p>

                  <div className="grid grid-cols-2 gap-1 md:gap-3 mb-[clamp(0.75rem,2vh,2rem)] text-[clamp(0.65rem,0.9vw,0.9rem)]">
          ...
          <motion.div variants={itemVariants} className="flex-1 min-h-0 w-full md:flex-none md:aspect-[16/10]">
            <SpotlightCard className="h-full rounded-2xl md:rounded-3xl bg-custom-purple/10 p-[clamp(1rem,2.5vw,2.5rem)] border-white/10 relative overflow-hidden group flex flex-col justify-center">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                  <div className="w-[clamp(2rem,4vw,3rem)] h-[clamp(2rem,4vw,3rem)] rounded-xl bg-white/10 flex items-center justify-center mb-[clamp(0.5rem,2vh,1.5rem)] border border-white/10 shrink-0">
                    <Star className="w-[clamp(1rem,2vw,1.5rem)] h-[clamp(1rem,2vw,1.5rem)] text-white" />
                  </div>
                  <h3 className="text-[clamp(1.25rem,2.5vw,2.5rem)] font-bold text-white mb-1 md:mb-2 shrink-0">Join The Roster</h3>
                  <p className="text-gray-300 text-[clamp(0.7rem,0.9vw,1rem)] mb-[clamp(0.75rem,2vh,2rem)] max-w-sm line-clamp-2 md:line-clamp-none">
                    Are you a world-class editor? Join our distributed team of creatives.
                  </p>

                  <div className="grid grid-cols-2 gap-1 md:gap-3 mb-[clamp(0.75rem,2vh,2rem)] text-gray-300 text-[clamp(0.65rem,0.9vw,0.9rem)]">
...
const FeatureItem = ({ text }: { text: string }) => (
  <div className="flex items-center gap-2">
    <div className="w-1 md:w-1.5 h-1 md:h-1.5 rounded-full bg-custom-bright flex-shrink-0" />
