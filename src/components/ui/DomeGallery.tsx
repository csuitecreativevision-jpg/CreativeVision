...
const DEFAULT_VIDEOS = [
  { src: 'https://youtube.com/watch?v=DFsizBNcfIA', alt: 'Long Form', isLandscape: true },
  { src: 'https://youtube.com/watch?v=4iQHoaFQr8E', alt: 'Long Form', isLandscape: true },
  { src: 'https://youtube.com/watch?v=sRM0RiUAvLg', alt: 'Long Form', isLandscape: true },
  { src: 'https://youtube.com/watch?v=WrCfTCyATGU', alt: 'Long Form', isLandscape: true },
  { src: 'https://youtube.com/watch?v=d1lVFDIV8Mg', alt: 'Long Form', isLandscape: true },
  { src: 'https://youtube.com/watch?v=dkhEOaGboGg', alt: 'Long Form', isLandscape: true },
  { src: 'https://youtube.com/watch?v=n4ha0vyW7Vc', alt: 'Short Form', isLandscape: false },
  { src: 'https://youtube.com/watch?v=g7EigqBCJco', alt: 'Short Form', isLandscape: false },
  { src: 'https://youtube.com/watch?v=l42-Sp68dLo', alt: 'Short Form', isLandscape: false },
  { src: 'https://youtube.com/watch?v=2lIv1gi_aLg', alt: 'Short Form', isLandscape: false },
  { src: 'https://youtube.com/watch?v=fEJw0Zg9yQA', alt: 'Long Form', isLandscape: true },
  { src: 'https://youtube.com/watch?v=JSgyhmA3X78', alt: 'Short Form', isLandscape: false },
  { src: 'https://youtube.com/watch?v=KXNxPS2JJWY', alt: 'Short Form', isLandscape: false },
  { src: 'https://youtube.com/watch?v=GP54C67DM2Q', alt: 'Short Form', isLandscape: false },
  { src: 'https://youtube.com/watch?v=iDqPyKDiBos', alt: 'Short Form', isLandscape: false },
];
...
function buildItems(pool: any[], seg: number) {
  ...
  const normalizedImages = pool.map(image => {
    if (typeof image === 'string') {
      return { src: image, alt: '', isLandscape: false };
    }
    return { src: image.src || '', alt: image.alt || '', isLandscape: !!image.isLandscape };
  });
  ...
  return coords.map((c, i) => ({
    ...
    isLandscape: usedImages[i].isLandscape
  }));
}
...
export default function DomeGallery({
  ...
  useEffect(() => {
    ...
    const close = () => {
      ...
      const originalMedia = overlay.querySelector('video') || overlay.querySelector('img') || overlay.querySelector('iframe');
      if (originalMedia) {
  ...
  const openItemFromElement = useCallback(
    (el: any) => {
      ...
      const isLandscape = parent.dataset.landscape === 'true';
