...
export const PortalWorkspaceCard = ({ name, itemCount = 0, onClick, color = '#8b5cf6', index = 0 }: PortalWorkspaceCardProps) => {
    // Clean up name (remove "- Workspace" suffix)
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-end justify-between">
                            <div className="space-y-1">
                                <span className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Active Cycles</span>
